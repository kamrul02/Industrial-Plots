    ...
    <div class="content" role="main">
    	...
    	<article class="post-detail">            
			<div class="entry">
				...
				<?php
					$id=safe($_GET['id']);
					$q="SELECT `JOB.id`, `title`, `contenu`, `type`, `continent`, `country`, `state`, `city`, `property`, `investd`, `investf`, `c` FROM job,country,state,continent,city,job.id WHERE job.id=$id AND job.country=country.id AND job.continent=continent.id AND job.state=state.id AND job.city=city.id ";
...
$l=mysqli_fetch_array($result) or die(mysqli_error($link));
    ...
    <div class="add-comment" id="addcomments">
                            ...
                            <div class="comment-form">
								<strong>Title : </strong><?php echo $l['title'] ?> 
							</div>
							<div class="clear"></div>
							<div class="comment-form">
							...
							<div class="comment-form">
								<strong>State : </strong><?php echo $l[4] ?> 
							</div>
						
							<div class="comment-form">
								<strong>City : </strong><?php echo $l['city'] ?> 
							</div>
