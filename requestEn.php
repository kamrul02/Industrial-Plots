    	...
    	<article class="post-detail">            
			<div class="entry">
				...
				<?php
					...
					$q="SELECT titleEn,contenuEn,continent.EnName,country.EnName,state.EnName,city.Name,property,investd,investf,job.id FROM job,continent,country,state,city WHERE job.id=$id AND job.country=country.id AND job.continent=continent.id AND job.state=state.id AND job.city=city.id ";
...
$l=mysqli_fetch_array($result) or die(mysqli_error($link));
    ...
    <div class="add-comment" id="addcomments">
                            ...
                            <div class="comment-form">
								<strong>Title: </strong><?php echo $l['titleEn'] ?> 
							</div>
							<div class="clear"></div>
							<div class="comment-form">
								<strong>Description : </strong><textarea cols=10 rows=5 disabled><?php echo $l['contenuEn'] ?> </textarea>
							</div>
							...
							<div class="comment-form">
                                ...
                                <a href="contact.php?lang=en"><input type="submit" name="send" id="send" value="Contact US" class="btn-submit"></a>                              
