...
<div class="header_image">
    ...
    <div class="topimage">
		...
		<div class="caption">
			<p><span>Our history speaks for itself - we’ve never lost a case!</span>  <a href="#" class="link-more">VIEW OUR HISTORY</a></p>
		</div>
    </div>
	
    <div class="header_quote">
    	<p>At Smiths & Doe, we view the attainment of diversity at all levels of our firm as crucial and as a natural result of building a cohesive, successful law firm. </p>
    </div>
...
<div id="middle" class="cols2 sidebar_left">
    	...
    	<article class="post-item post-detail">
			...
			<div class="entry">
            	...
            	<p><span class="text-red"><strong>2007</strong></span><strong> - VIVAMUS HENDERIT</strong><br>
            	  Nullam in dui mauris. Vivamus hendrerit arcu sed erat molestie vehicula. Sed auctor neque eu tellus rhoncus ut eleifend nibh porttitor. Ut in nulla enim. Phasellus molestie magna.</p>
            	<p><span class="text-red"><strong>2008</strong></span><strong> - PRAESENT ID METUS</strong><br>
            	  Sed auctor neque eu tellus rhoncus ut eleifend nibh porttitor. Ut in nulla enim. Phasellus molestie magna non est bibendum non venenatis nisl tempor. Suspendisse dictum feugiat nisl ut dapibus. Mauris iaculis porttitor posuere. Praesent id metus massa, ut blandit odio. Proin quis tortor orci. Etiam at risus et justo dignissim congue. Donec congue lacinia dui, a porttitor lectus condimentum laoreet. Nunc eu ullamcorper orci. Quisque eget odio.</p>
                  
				<h2 id="anchor2">Meet the Team:</h2>
                ...
                <div class="row">
                	<div class="col col_1_3">
                    	<div class="inner">	
                            ...
                            <a href="#"><img src="images/temp/team_1.jpg" alt="Mayra Smiths"></a>
                            <p class="wp-caption-text">Mayra Smiths</p>
                            </div>
                    ...
                    <div class="col col_1_3">
                    	<div class="inner">	
                            ...
                            <div class="wp-caption alignnone">
                            <a href="#"><img src="images/temp/team_2.jpg" alt="Jacob Marshall"></a>
                            <p class="wp-caption-text">Jacob Marshall</p>
                            </div>
                    ...
                    <div class="col col_1_3">
                    	<div class="inner">	
                            ...
                            <div class="wp-caption alignnone">
                            <a href="#"><img src="images/temp/team_3.jpg" alt="Marcia Lanham"></a>
                            <p class="wp-caption-text">Marcia Lanham</p>
                            </div>
                ...
                <h2 id="anchor3">Our Philosophy:</h2>
    ...
    <div class="sidebar">
        ...
        <div class="widget-container widget_nav_menu nav_style2">
			<ul>
				<li><a href="#anchor1">Our Firm's History</a></li>
                <li><a href="#anchor2">Meet the Team</a></li>                              
				<li><a href="#anchor3">Philosophy</a></li>                        	
				<li><a href="#anchor4">Media / In the Press</a></li>  				
			</ul>
		</div>
        <!--/ widget_nav_menu, style2  -->
