    	...
    	<article class="post-detail">            
			<div class="entry">
				...
				<?php
					...
					$q="SELECT titleFr,contenuFr,continent.EnName,country.EnName,state.EnName,city.Name,property,investd,investf,job.id FROM job,continent,country,state,city WHERE job.id=$id AND job.country=country.id AND job.continent=continent.id AND job.state=state.id AND job.city=city.id ";
...
$l=mysqli_fetch_array($result) or die(mysqli_error($link));
    ...
    <div class="add-comment" id="addcomments">
                            ...
                            <div class="comment-form">
								<strong>Titre : </strong><?php echo utf8_encode($l['titleFr']) ?> 
							</div>
							<div class="clear"></div>
							<div class="comment-form">
								<strong>Description : </strong><textarea cols=10 rows=5 disabled><?php echo utf8_encode($l['contenuFr']) ?> </textarea>
							</div>
							...
							<div class="comment-form">
								<strong>Pays : </strong><?php echo $l[3] ?> 
							</div>
							
							<div class="comment-form">
								<strong>Etat fédéral : </strong><?php echo $l[4] ?> 
							</div>
							...
							<div class="comment-form">
                                ...
                                <a href="contact.php?lang=fr"><input type="submit" name="send" id="send" value="Contact US" class="btn-submit"></a>                              
