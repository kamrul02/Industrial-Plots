...
<div id="middle" class="full_width">
  ...
  $<input type="text" name="amountd">- $<input type="text" name="amountf"><br>
	   ...
	   $descrip=$_POST['descrip'];
			...
			$sql="INSERT INTO `job`( `title`, `contenu`, `type`, `continent`, `country`, `state`, `city`, `property`, `investd`, `investf`) VALUES('$title','$descrip','Shop','$continent','$country','$state','$city','$job',$amountd,$amountf)";
